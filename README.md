📹 Real-Time WebRTC Video Calling Platform
...
⚡ Optimized signaling flow reducing call join time by ~30%
🐳 Dockerized setup with CI/CD support
🛠️ Tech Stack
⚛️ Frontend: React, WebRTC APIs
